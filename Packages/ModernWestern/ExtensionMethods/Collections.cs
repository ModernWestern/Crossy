...
public static class CollectionsExtensions
{
    ...
    /// <summary>
    /// Performs the specified action on each element of the input array and returns a new array with the updated elements.
    /// </summary>
    /// <typeparam name="T">The type of elements in the array.</typeparam>
    /// <param name="collection">The input array of elements to iterate over.</param>
    /// <param name="action">The action to perform on each element of the input array.</param>
    ...
    /// <summary>
    /// Returns a new array that is a deep copy of the input array.
    /// </summary>
    /// <typeparam name="T">The type of elements in the array.</typeparam>
    /// <param name="array">The input array to clone.</param>
    /// <returns>A new array that is a deep copy of the input array.</returns>
    ...
    /// <summary>
    /// Searches the input collection for a child object with a component of type T.
    /// </summary>
    /// <typeparam name="T">The type of component to search for.</typeparam>
    /// <param name="collection">The input collection of child objects.</param>
    ...
    /// <summary>
    /// Checks if any element in the input array matches the provided condition.
    /// </summary>
    /// <typeparam name="T">The type of elements in the array.</typeparam>
    /// <param name="collection">The input array to search.</param>
    ...
    /// <param name="collection">The input array to convert.</param>
    /// <param name="converter">The function that converts elements from TInput to TOutput. e.g. t => t as tu, t => (tu)t, t => t.tu.</param>
    /// <returns>A sequence of type TOutput containing all elements from the input array converted using the provided converter function.</returns>
    ...
    /// <param name="array">The input array to check.</param>
    ...
    /// <param name="first">The first input sequence to compare.</param>
    /// <param name="second">The second input sequence to compare.</param>
    ...
    /// <param name="collection">The input enumerable object to check.</param>
    ...
    /// <typeparam name="T">The type of the elements in the enumerable object.</typeparam>
    /// <param name="collection">The input enumerable object to check.</param>
    /// <param name="result">The input enumerable object.</param>
    /// <returns>True if the enumerable object is not null and contains at least one element, false otherwise.</returns>
    ...
    /// <typeparam name="T">The type of the elements in the enumerable object.</typeparam>
    /// <param name="collection">The input enumerable object to check.</param>
    /// <param name="result">The input enumerable object as array.</param>
    /// <returns>True if the enumerable object is not null and contains at least one element, false otherwise.</returns>
    ...
    /// <typeparam name="T">The type of the elements in the enumerable object.</typeparam>
    /// <param name="collection">The input enumerable object to check.</param>
    /// <param name="result">The input enumerable object as list.</param>
    /// <returns>True if the enumerable object is not null and contains at least one element, false otherwise.</returns>
    ...
    /// </summary>
    /// <typeparam name="T">The type of the elements in the enumerable object.</typeparam>
    /// <param name="collection">The input enumerable object to split.</param>
    /// <param name="size">The maximum size of each chunk. e.g. { 1, 2, 3, 4, 5 }.Split(2) = { { 1, 2 }, { 3, 4 }, { 5 } }</param>
    /// <returns>An enumerable object containing the smaller chunks of the input enumerable object.</returns>
